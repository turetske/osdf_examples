...
1) Access CESM2 LENS data from the AWS opendata origin and the NCAR data origin and
   - a) [Benchmark](notebooks/aws_benchmark.ipynb) data access speeds for subsets of various sizes.
...
3) Benchmark data access speeds from the NCAR data [origin](notebooks/ncar_benchmark.ipynb) using the DART reanalysis dataset
4) Benchmark data access speeds from the NCAR's data [origin](notebooks/ncar_benchmark_ap40.ipynb), when the data is accessed from the OSPool's access point AP40
